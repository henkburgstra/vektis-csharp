...
namespace Vektis.Tests.Mock {
	public class Zorgactiviteitrecord_9_0: VektisData {
		public Zorgactiviteitrecord_9_0(dynamic item = null) {
			Item = item;
		}
		/// <summary>
		...
		/// <summary>
		///  Datum waarop de zorgactiviteit feitelijk is of wordt uitgevoerd. Als de zorgactiviteit
		/// betrekking heeft op meerdere dagen dan is het de begindatum.
		/// </summary>
		...
		/// <summary>
		///  Datum waarop de zorgactiviteit is beëindigd, als de zorgactiviteit betrekking heeft op
		/// meerdere dagen.
		/// </summary>
		...
		/// <summary>
		///  De code van de instelling waar de zorgactiviteit is uitgevoerd, afwijkend van de declarerende
		/// instelling.
		/// </summary>
		...
		/// <summary>
		///  Uniek referentienummer die de zorgverlener heeft toegekend aan een voorgaand
