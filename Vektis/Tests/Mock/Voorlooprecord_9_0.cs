...
namespace Vektis.Tests.Mock {
	public class Voorlooprecord_9_0: VektisData {
		...
		/// <summary>
		///  Volgnummer van de formele uitgifte van een versie van een
		/// (externe-integratie)berichtstandaard.
		/// </summary>
		public int versienummer_berichtstandaard() {
			return 0;
		}
		/// <summary>
		///  Volgnummer binnen het versienummer van een (externe-integratie) berichtstandaard. Volgnummer
		/// van de formele uitgifte van een subversie van een (Externe Integratie) berichtstandaard.
		/// </summary>
		...
		/// <summary>
		///  Identificerende code van een servicebureau. Een servicebureau is een dienstverlenende
		/// organisatie (eenheid), die een (elektronische) schakel vormt tussen zorgverleners
		/// (vrijgevestigde beroepsbeoefenaren en zorginstellingen) en zorgverzekeraars.
		/// </summary>
		...
		/// <summary>
		///  Laatste dag van een administratieve periode waarop de gegevensuitwisseling betrekking heeft.
		/// Dit betreft niet per definitie de einddatum van de laatste behandeling.
		/// </summary>
