...
namespace Vektis.Tests.Mock {
	public class Prestatierecord_9_0: VektisData {
		public Prestatierecord_9_0(dynamic item = null) {
			Item = item;
		}
		/// <summary>
		...
		/// <summary>
		///  Code die aangeeft of het doorsturen van de desbetreffende prestatie met daaraan verbonden
		/// declaratie naar de zorgverzekeraar is toegestaan.
		/// </summary>
		...
		/// <summary>
		///  Een (DBC)zorgproduct is het declarabele product dat door de Grouper wordt afgeleid uit de
		/// declaratiedataset, met ingang van de nieuwe DBC declaratiesystematiek gebaseerd op DOT.
		/// </summary>
		...
		/// <summary>
		///  Nadere verbijzondering van de zorgverlener per soort/beroepsgroep. Nadere identificatie van
		/// de categorie waartoe een voorschrijvende of verwijzende zorgverlener behoort.
		/// </summary>
		...
		/// <summary>
		///  Het zorgtype is een component waarmee op het niveau van het declaratietraject de geleverde
		/// (en te declareren) zorg wordt getypeerd.
		/// </summary>
		...
		/// <summary>
		///  Code die aangeeft welke diagnosecodelijst gebruikt is, met aanduiding van de oorsprong van de
		/// codes en/of de beheerder ervan.
		/// </summary>
		...
		/// <summary>
		///  De primaire medische diagnose geeft de reden aan van het in behandeling nemen of zijn van een
		/// persoon.
		/// </summary>
		...
		/// <summary>
		///  Indicatie die aangeeft of er volgens de behandelaar sprake is van een aanspraak op de
		/// zorgverzekeringswet.
		/// </summary>
		...
		/// <summary>
		///  De indicatie machtiging geeft aan dat er in het profiel van het zorgproduct minstens één
		/// "oranje" zorgactiviteit voorkomt waarvoor een machtiging vereist is.
		/// </summary>
		public string indicatie_machtiging() {
			return "";
		}
		/// <summary>
		///  De indicatie producttyperende oranje zorgactiviteit geeft aan dat er in het profiel van een
		/// zorgproduct een oranje zorgactiviteit voorkomt die bepalend is voor de afleiding van dit
		/// zorgproduct.
		/// </summary>
		...
		/// <summary>
		///  Een zorgactiviteit is een verrichting die is uitgevoerd bij het leveren van zorg aan de
		/// patiënt
		/// </summary>
		...
		/// <summary>
		///  Dit is een uniek nummer dat binnen een zorginstelling wordt toegekend aan een uitgevoerde
		/// zorgactiviteit.
		/// </summary>
		...
		/// <summary>
		///  Door paramedicus gecodeerde verwijsdiagnose (opgesteld/omschreven door verwijzend huisarts,
		/// specialist, enz.).
		/// </summary>
		...
		/// <summary>
		///  Code die aangeeft van welke soort indicatie paramedische hulp sprake is, n.a.v. de Regeling
		/// Paramedische Hulp.
		/// </summary>
		...
		/// <summary>
		///  Aanduiding over een patiënt die als gevolg van een ongeval (noodzakelijk) een prestatie
		/// (zorg) ondergaat.
		/// </summary>
		...
		/// <summary>
		///  Uniek referentienummer dat de zorgverlener heeft toegekend aan deze declaratie voor (een deel
		/// van) de prestatie.
		/// </summary>
		...
		/// <summary>
		///  Uniek referentienummer dat de zorgverlener heeft toegekend aan een voorgaande prestatie, die
		/// gerelateerd is aan deze prestatie.
		/// </summary>
